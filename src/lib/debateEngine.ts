...
export const beginnerDebateSteps: DebateStep[] = [
  {
    ...
    instruction: `찬성/반대 입장을 정하고 주장(Claim), 이유(Reason), 근거(Evidence)를 구분해 입론하세요.`,
    tasks: [
      ...openingReasoningTerms,
      '찬성 또는 반대 입장을 선택한다.',
      '자신의 주장을 한 문장으로 말한다.',
      '주장을 뒷받침하는 이유(Reason)를 1~2개 제시한다.',
      '각 이유에 대해 왜 그런지 설명한다.',
      '가능하면 간단한 예시를 덧붙인다.',
      'AI는 반대편 입론을 제시한다.',
    ],
    checklist: [
      '내 입장이 찬성/반대 중 분명한가?',
      '주장이 한 문장으로 명확하게 정리되었는가?',
      '이유가 주장과 연결되어 있는가?',
      '이유에 맞는 근거가 제시되었나?',
      '예시가 주장을 뒷받침하는가?',
      '감정이나 느낌이 아니라 이유를 바탕으로 말하고 있는가?',
    ],
    sentenceFrames: [
      '저는 ___에 찬성/반대합니다.',
      '제 주장은 ___입니다.',
      '그 이유는 첫째, ___이기 때문입니다.',
      '이 이유를 뒷받침하는 근거는 ___입니다.',
    ],
    recommendedDurationSeconds: 150,
    inputPlaceholder: '입장: 찬성/반대\n주장(Claim): ...\n이유(Reason): ...\n근거(Evidence): ...\n예시: ...',
  },
  {
    ...
    title: '교차질문',
    actor: 'user',
    purpose: '상대방 주장의 의미, 근거, 이유를 확인하고 의문점을 질문한다.',
  ...
  },
  {
    ...
    checklist: [
      '상대 주장 파악력: 상대방의 핵심 주장을 정확히 짚었는가?',
      '근거 검증력: 신뢰성·관련성·충분성을 구체적으로 검토했는가?',
      '약점 파악력: 상대방 주장 중 약한 부분을 구체적으로 찾았는가?',
    ],
    sentenceFrames: [
      '상대방은 ___라고 주장합니다.',
  ...
  },
  {
    ...
    title: '반박',
    actor: 'user',
    purpose: '상대 주장의 결론만 부정하지 말고, 그 결론을 뒷받침하는 이유·근거·해결책 중 가장 약한 부분을 찾아 반박한다.',
    instruction: '상대 주장 점검에서 확인한 이유, 근거, 약점을 바탕으로 상대 논증의 비약이나 모순을 지적하세요.',
    tasks: [
      '상대 주장 점검에서 확인한 약한 부분을 고른다.',
    ...
    checklist: [
      '상대 주장 점검에서 확인한 이유, 근거, 약점을 바탕으로 반박했는가?',
    ...
    inputPlaceholder: '상대 주장 점검에서 찾은 약한 부분: ...\n약한 이유/근거/해결책: ...\n논리적 비약/모순: ...\n대안 제시: 현실성/부작용 ...\n내 반박: ...',
  },
  {
...
export const intermediateDebateSteps: DebateStep[] = [
  {
    id: 'intermediate-definition-user',
    roundId: 'opening',
    title: '논제 확인 및 용어 정리',
    actor: 'user',
    purpose: '토론할 논제의 의미와 핵심 용어를 명확히 정리한다.',
    instruction: '논제가 묻는 핵심 질문, 핵심 용어, 토론 범위, 판단 기준을 먼저 정리하세요.',
    tasks: [
      '논제가 묻는 핵심 질문을 한 문장으로 정리한다.',
      '핵심 용어를 정의한다.',
      '토론의 범위를 정한다.',
      '이 논제를 판단할 기준을 1~2개 설정한다.',
    ],
    checklist: [
      '논제가 실제로 묻는 문제가 무엇인지 파악했는가?',
      '핵심 용어의 의미가 명확한가?',
      '논의 범위가 너무 넓거나 좁지 않은가?',
      '판단 기준이 제시되었는가?',
      '용어 정의가 억지스럽지 않고 공정한가?',
    ],
    sentenceFrames: [
      '이 논제는 결국 ___에 관한 문제입니다.',
      '여기서 ___란 ___을 의미합니다.',
      '토론 범위는 ___로 한정하겠습니다.',
      '판단 기준은 ___와 ___입니다.',
    ],
    recommendedDurationSeconds: 80,
    inputPlaceholder: '핵심 질문: ...\n핵심 용어 정의: ...\n토론 범위: ...\n판단 기준 1~2개: ...',
  },
  {
    ...
    title: '입론',
    actor: 'user',
    purpose: '논제에 대한 자신의 입장을 세우고, 판단 기준에 맞는 근거를 제시한다.',
    instruction: '판단 기준과 연결되는 입장을 세우고, 근거 2개 이상에 이유, 예시, 예상 효과를 붙이세요.',
    tasks: [
      ...reasoningTerms,
      '찬성 또는 반대 입장을 명확히 제시한다.',
      '판단 기준을 제시한다.',
      '주장을 뒷받침하는 근거를 2개 이상 제시한다.',
  ...
  },
  {
    ...
    title: '교차질문',
    actor: 'user',
    purpose: '상대방 주장의 전제, 근거, 범위, 대안을 확인하고 약점을 드러낸다.',
  ...
  },
  {
    ...
    checklist: [
      '쟁점 파악력: 승패를 가르는 핵심 쟁점을 정확히 짚었는가?',
      '전제 분석력: 상대 주장의 핵심 전제를 명확히 드러냈는가?',
      '근거 검증력: 신뢰성·관련성·충분성을 구체적으로 검토했는가?',
      '충돌 지점 파악: 토론의 핵심 쟁점과 충돌되는 부분을 정확히 파악했는가?',
    ],
    sentenceFrames: [
      '상대방은 ___라고 주장합니다.',
  ...
  },
  {
    ...
    title: '반박',
    actor: 'user',
    purpose: '상대 주장의 결론만 부정하지 말고, 그 결론이 성립하기 위해 필요한 전제·근거·해결책·우선순위 중 가장 약한 부분을 찾아 반박한다.',
    instruction: '상대 주장 점검에서 확인한 핵심 쟁점, 핵심 전제, 근거 타당성을 바탕으로 상대 논증의 비약이나 모순을 정확히 지적하세요.',
    tasks: [
      '상대 주장 점검에서 확인한 핵심 쟁점과 핵심 전제를 선택한다.',
    ...
    checklist: [
      '상대 주장 점검에서 검증한 핵심 쟁점, 핵심 전제, 근거 타당성을 바탕으로 반박했는가?',
      '상대 논증의 비약이나 모순을 정확히 지적했는가?',
      '대안 제시력: 현실적이고 부작용이 적은 대안을 제시했는가?',
    ],
    sentenceFrames: [
      '상대 주장 점검에서 확인한 핵심 쟁점은 ___입니다.',
    ...
    inputPlaceholder: '상대 주장 점검에서 찾은 핵심 쟁점: ...\n핵심 전제/근거 타당성: ...\n약한 해결책/우선순위: ...\n논리적 비약/모순: ...\n대안 제시: 현실성/부작용 ...\n내 반박: ...',
  },
  {
