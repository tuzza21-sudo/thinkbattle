...
export const beginnerDebateSteps: DebateStep[] = [
  ...
  },
  {
    ...
    title: '반박',
    actor: 'user',
    purpose: '상대 논리가 왜 부족한지 결론을 내린다.\n형식: 주장 + 이유 + 근거를 사용한다.\n교차질문과 답변에서 얻은 정보를 바탕으로 논리적으로 공격한다.',
    instruction: '교차질문과 답변에서 확인한 이유, 근거, 약점을 바탕으로 상대 논증의 비약이나 모순을 지적하세요.',
    tasks: [
      '교차질문과 답변에서 확인한 약한 부분을 고른다.',
...
export const intermediateDebateSteps: DebateStep[] = [
  ...
  },
  {
    ...
    title: '상대 전제 분석',
    actor: 'user',
    purpose: '상대방의 결론이 성립하기 위해 반드시 참이어야 하는 숨겨진 전제와 가정을 찾아 이후 반박의 출발점을 만든다.',
    instruction: '상대의 주장과 이유 사이에 생략된 연결고리를 찾고, 상대 결론이 의존하는 핵심 전제·숨겨진 가정·적용 조건이 타당한지 분석하세요.',
    tasks: [
      '상대의 결론과 이를 뒷받침하는 이유를 구분한다.',
      '상대 주장이 의존하는 핵심 전제를 드러낸다.',
      '말로 드러나지 않은 숨겨진 가정과 적용 조건을 찾는다.',
      '그 전제가 사실인지, 항상 성립하는지, 예외는 없는지 검토한다.',
    ],
    checklist: [
      '상대의 실제 주장과 이유를 왜곡 없이 파악했는가?',
      '이유에서 결론으로 넘어갈 때 필요한 숨겨진 전제를 명시했는가?',
      '찾은 전제가 타당한지 또는 예외가 있는지 검토했는가?',
    ],
    sentenceFrames: [
      '상대방은 ___라고 주장합니다.',
      '이 결론이 성립하려면 ___가 참이어야 합니다.',
      '상대가 말하지 않았지만 전제한 것은 ___입니다.',
      '하지만 이 전제는 ___한 경우 성립하지 않습니다.',
    ],
    recommendedDurationSeconds: 90,
    inputPlaceholder: '상대 결론이 의존하는 숨겨진 전제와 가정을 분석해보세요.',
  },
  {
    ...
    instruction: '교차질문/상대 전제 분석에서 확인한 핵심 전제와 숨겨진 가정을 바탕으로 상대 논증의 비약이나 모순을 정확히 지적하세요.',
    tasks: [
      '상대 전제 분석에서 확인한 핵심 전제와 숨겨진 가정을 선택한다.',
    ...
    checklist: [
      '교차 질문에서 질문한 내용과 답변으로 반박을 구성했는가?',
      '상대 전제 분석에서 검증한 핵심 전제와 숨겨진 가정을 바탕으로 반박했는가?',
      '상대 논증의 비약이나 모순을 정확히 지적했는가?',
      '대안 제시력: 현실적이고 부작용이 적은 대안을 제시했는가?',
    ],
    sentenceFrames: [
      '상대 전제 분석에서 확인한 숨겨진 전제는 ___입니다.',
